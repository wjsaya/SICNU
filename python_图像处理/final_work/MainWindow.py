...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 350, 305))
        ...
        self.menuwenjian.addAction(self.action_2)
        self.menuwenjian.addAction(self.action_3)
        self.menuwenjian.addAction(self.action)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action_2.setText(_translate("MainWindow", "打开(ctrl+o)"))
        self.action_3.setText(_translate("MainWindow", "保存(ctrl+s)"))
